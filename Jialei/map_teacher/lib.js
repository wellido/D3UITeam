function map(container, data) {
  ...
  var countryDiv=container.append('div').attr('id','country')
      .style('display', 'flex')
    .style('background', 'black')
    .style('justify-content', 'center')
    .style('align-items', 'center');//国家地图
...
/****************************************************************/	
  ...
  g2.selectAll('path')
    ...
    .attr('fill', '#404040')//rgb(50, 85, 142)
    .attr('stroke', '#272727')//rgb(65, 100, 158)
    .attr('stroke-width', '2')
    .on('click', function(d) { 
	  zoom_in(d.id,d.properties.cp);
...
/********************让地图获取数据的方法********************************************/
  ...
  function getData() {
    ...
    d3.json("mapdata.json", function (e, d) {
    //console.log(e, d);
      if(!e) {
	    data = d;
