...
function loadHealthDiv(){
	...
	healthPoints.append("span")
		    	.attr("class","hp-health")
		   		.html("健康度");
	var r = 40;
//	var datas_oh = [78,79,56];
//	var titles = ["手机银行","网银","EAL"];
//	var updateFunctions = ["health_phone1","health_phone2","health_phone3","health_phone4"];
	var updateFunctions = ["health_phone1"];
//	healthPoints.append("span")
//  	.attr("class","hp-number")
//  	.html(function(){
//  		for(var item in datas_oh) {
//	    		if(item < 60){
//	    			return '<lable style="color:' + color[2] + ';" >' + item + '</lable>';
//	    		}else if(item < 90){
//	    			return '<lable style="color:' + color[0] + ';" >' + item + '</lable>';
//	    		}else{
//	    			return '<lable style="color:' + color[1] + ';" >' + item + '</lable>';
//	    		}
//  		}
//  	});
	healthPoints.append("span")
